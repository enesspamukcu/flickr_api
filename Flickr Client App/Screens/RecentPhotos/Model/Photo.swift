...
struct Photo: Codable {
    ...
    let iconfarm: Int?
    let views, machineTags, media, mediaStatus: String?
    let urlSq: String?
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case dateupload, lastupdate, datetaken, datetakengranularity, datetakenunknown, ownername, iconserver, iconfarm, views
